...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // includes/projectCards.js
  var projectCards_default = () => ({
    open: false,
    projects: [
      ...
      { title: "Rush-hour", subjects: ["AI", "Programming"], tools: ["Prolog"], link: "projects/rush-hour.html", description: "Coding a GUI and AI to play rush hour.", isCol2: false },
    ...
    isProjectSecondColumn(project) {
      if (isOneColumnDisplay()) {
        ...
        const filteredProjects = this.projects.filter((project2) => this.matchSelectedCriteria(project2));
    ...
    matchSelectedCriteria(project) {
      ...
      const hasAllSelectedSubjects = this.selectedSubjects.every(
        (subject) => project.subjects.includes(subject)
      );
      const hasAllSelectedTools = this.selectedTools.every(
